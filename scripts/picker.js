export const options = [{
  ...
  list: [
    ...
    {no:775,artist:'my bloody valentine',album_name:'loveless',year:1991,genre:'Shoegaze',length:'48 mins',tracks:11,review:`<p>"Loveless" is the second studio album by the Irish-English rock band My Bloody Valentine, released in November 1991. The album is widely regarded as a landmark in the shoegaze genre, known for its dense, immersive soundscapes and innovative production techniques. "Loveless" is characterized by its use of heavily layered guitars, often described as a "wall of sound," combined with ethereal vocals and intricate melodies. The album's unique sound was achieved through extensive use of effects pedals, pitch bending, and studio experimentation, creating a dreamy, almost otherworldly atmosphere. Tracks like "Only Shallow" and "When You Sleep" are emblematic of the album's rich textures and hypnotic rhythms.</p>
      <p>The creation of "Loveless" was infamously protracted and costly, with the recording process spanning nearly two years and involving multiple studios. Despite the challenges, the band, led by Kevin Shields, succeeded in crafting an album that pushed the boundaries of what rock music could sound like. The album's lyrics are often obscured in the mix, adding to its enigmatic and haunting quality. While the vocals are understated, they complement the swirling guitar work and contribute to the overall sense of disorientation and beauty that defines the album. The production, which layers sound upon sound, results in a listening experience that is both overwhelming and deeply emotive.</p>
      <p>Upon its release, "Loveless" received critical acclaim and has since been hailed as one of the greatest albums of the 1990s. It has had a lasting influence on a wide range of genres, including indie rock, alternative, and electronic music. The album's innovative approach to sound and texture has inspired countless artists and continues to be revered by fans and critics alike. "Loveless" remains a seminal work in My Bloody Valentine's discography, and its impact on music is still felt today, making it a timeless classic in the world of alternative music.</p>`
    }        
  ]
},{id:"2",
  type:'creator',
  ...
  <p><em>I'm in Your Mind Fuzz</em> is often celebrated for its high energy and relentless pace, encapsulating the band's unique approach to psychedelic rock. It has become a standout album in their catalog, beloved by fans for its immersive and electrifying experience.</p>
        `},
        {no:654,artist:'The Sound',album_name:'Jeopardy',year:'1980',genre:'Post Punk',length:'39 mins',tracks:11,review:`<p>Jeopardy is the debut studio album by the English post-punk band The Sound, released in November 1980. The album emerged during a period when the post-punk genre was thriving, and it quickly established The Sound as a significant band within the scene. Produced by Adrian Borland and Nick Robbins, Jeopardy is characterized by its raw, energetic sound, blending dark, introspective lyrics with driving rhythms and jangly guitars. The album's mood is both tense and atmospheric, reflecting the anxieties of the time while also showcasing Borland's distinctive vocal delivery and the band's tight musicianship.</p>
  <p>The album features standout tracks such as "I Can't Escape Myself," "Heartland," and "Missiles," each of which exemplifies The Sound's ability to craft songs that are both emotionally resonant and musically compelling. The lyrics often explore themes of alienation, inner turmoil, and societal disillusionment, which resonated deeply with the post-punk audience. Despite its critical acclaim, Jeopardy did not achieve significant commercial success upon its release, but it has since gained a cult following and is regarded as one of the defining albums of the post-punk era.</p>
  <p>Jeopardy is often praised for its intensity and authenticity, with many considering it a hidden gem within the post-punk genre. The album's minimalist production, combined with its emotionally charged content, has ensured its lasting influence and enduring appeal. Over the years, Jeopardy has been reissued and continues to be celebrated by fans of post-punk and alternative music, solidifying The Sound's place in music history despite their relatively short-lived career.</p>`
        },
        {no:168,artist:'Bark Psychosis',album_name:'Hex',year:1994,genre:'Post Rock',length:'53 mins',tracks:7,review:`<p>"Hex" is the debut studio album by the English band Bark Psychosis, released in 1994. The album is widely regarded as a pioneering work in the genre that would later be known as post-rock. Bark Psychosis, led by Graham Sutton, crafted an album that blends elements of ambient, jazz, and rock, creating a sound that is atmospheric, textured, and introspective. The music on "Hex" is characterized by its use of space, subtle dynamics, and an emphasis on mood over traditional song structures. Tracks like "The Loom" and "A Street Scene" exemplify the band's ability to create immersive soundscapes that draw the listener into their unique sonic world.</p>
  <p>"Hex" was recorded in various locations, including a disused church, which contributed to the album's rich, reverberant sound. The production is meticulous, with each instrument and sound carefully placed to build the album's distinctive atmosphere. The album's compositions often unfold slowly, with an emphasis on creating tension and release through the use of minimalism and repetition. Lyrically, the album touches on themes of urban decay, existential angst, and emotional introspection, reflecting the bleak yet beautiful tone of the music.</p>
  <p>Despite its critical acclaim, "Hex" did not achieve major commercial success, but it has since become a cult classic and is considered a landmark release in the evolution of post-rock. The album's influence can be heard in the work of later bands in the genre, and it remains a touchstone for fans and musicians alike. "Hex" is celebrated for its innovation and its ability to create a deeply emotional and atmospheric listening experience, solidifying Bark Psychosis as one of the most important and influential bands in the post-rock movement.</p>`
        },
        {no:871,artist:'Godspeed You! Black Emperor',album_name:'F♯ A♯ ∞',year:'1998',genre:'Post Rock',length:'1hrs',tracks:3,review:`<p>"F♯ A♯ ∞" is the debut studio album by the Canadian post-rock band Godspeed You! Black Emperor, released in 1997. The album is notable for its expansive, cinematic sound, blending elements of orchestral music, drone, and ambient with rock instrumentation. "F♯ A♯ ∞" is divided into two long tracks, each split into multiple movements, creating a continuous, evolving narrative through sound. The album's haunting atmosphere is built through the use of field recordings, tape loops, and a wide array of instruments, including strings, guitars, and percussion. The music is both dark and beautiful, often evoking a sense of apocalyptic foreboding.</p>
  <p>The album's title, "F♯ A♯ ∞", reflects its thematic ambiguity and its sense of infinite, unresolved tension. The tracks, "The Dead Flag Blues" and "East Hastings," are known for their slow builds, crescendos, and stark contrasts between moments of quiet introspection and intense, powerful climaxes. The band's use of unconventional structures and extended compositions set them apart from other bands at the time and established their reputation as pioneers of the post-rock genre. The album's production is raw and organic, contributing to its visceral impact and emotional depth.</p>
  <p>Since its release, "F♯ A♯ ∞" has been critically acclaimed and is considered a seminal work in the post-rock genre. The album's influence can be seen in the work of many bands that followed, and it remains a touchstone for its innovative approach to composition and sound design. Godspeed You! Black Emperor's ability to create a deeply immersive and emotionally charged listening experience with "F♯ A♯ ∞" has solidified the album's place as a landmark release in experimental music, continuing to captivate listeners with its timeless and otherworldly sound.</p>`
        },
        {no:591,artist:'Julia Holter',album_name:'Have You In My Wilderness',year:2015,genre:'Dream Pop',length:'47 mins',tracks:10,review:`<p>"Have You in My Wilderness" is the fourth studio album by American singer-songwriter and multi-instrumentalist Julia Holter, released in September 2015. The album marks a significant evolution in Holter's sound, blending her experimental roots with more accessible, pop-oriented elements. "Have You in My Wilderness" is characterized by its lush orchestration, intricate arrangements, and Holter's ethereal vocals. The songs on the album explore themes of love, desire, and human connection, all while maintaining a sense of mystery and introspection. Tracks like "Feel You" and "Sea Calls Me Home" exemplify the album's delicate balance between complexity and emotional directness.</p>
  <p>The album's production is richly textured, with a focus on layering strings, keyboards, and subtle electronic elements to create an immersive soundscape. Holter's songwriting on "Have You in My Wilderness" is both sophisticated and deeply personal, drawing on influences from classical music, jazz, and art-pop. The album's lyrics often weave poetic imagery with narrative fragments, inviting listeners into a world that is both intimate and elusive. The combination of Holter's expressive voice and the album's meticulous production results in a listening experience that is both captivating and haunting.</p>
  <p>"Have You in My Wilderness" received widespread critical acclaim upon its release, with many praising its blend of experimental ambition and melodic beauty. The album was celebrated for its artistic depth and emotional resonance, solidifying Julia Holter's reputation as one of the most innovative and compelling artists in contemporary music. As a work that bridges the gap between the avant-garde and the accessible, "Have You in My Wilderness" remains a standout in Holter's discography and a beloved album among fans of art-pop and experimental music.</p>`
}]
},{
  id:"3",
  type:'ambient',
...
{no:6,artist:'Steve Roach',album_name:'Structures From Silence',year:1984,genre:'Space Ambient',length:'58 mins',tracks:3,review:`<p><strong>Structures from Silence</strong> is the third studio album by American ambient musician Steve Roach, released in 1984. The album is considered a classic in the ambient genre, known for its serene and meditative soundscapes that have been influential in the development of ambient and new age music.</p>
...
{no:9,artist:'Tangerine Dream',album_name:'Phaedra',year:1974,genre:'Ambient',length:'37 mins',tracks:4,review:`<p><strong>Phaedra</strong> is the fifth studio album by the German electronic music group Tangerine Dream, released in 1974. The album is a landmark in the development of electronic music, known for its pioneering use of synthesizers and its exploration of cosmic and otherworldly themes.</p>
...
export function renderAlbum(){
    ...
    console.log(localStorage.getItem('v'));
      ...
      ttip.innerText = `${list[v].album_name}`;
